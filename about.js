const aboutData = {
    name: "Михаил",
    bio: "Меня зовут Михаил. Это карта моего велопутешествия (если я в пути). Также здесь собраны все мои предыдущие велопутешествия. После нажатия на кружок откроется окошко, там будет небольшая информация от ночевке. Также будет ссылка на пост в ВК, и трек за текущий день (конечно если он будет записан).мммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммммм",
