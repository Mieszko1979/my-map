const aboutData = {
    name: "Здравствуйте!",
    bio: "Меня зовут Михаил. Перед вами — карта моего велопутешествия. Если я сейчас в пути, вы можете следить за моим маршрутом почти в реальном времени. Нажимайте на точки, чтобы узнать детали дня: где была ночевка, посмотреть трек (если он был записан) и перейти к ежедневному отчету в ВК. Можно посмотреть фотографии на маршруте. В меню также доступны архивы прошлых велопутешествий. Подписывайтесь на мои соцсети и приятного просмотра! А если у вас возникнет желание поддержать проект, сделать это можно по кнопке ниже. Всем спасибо!",
