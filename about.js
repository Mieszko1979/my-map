const aboutData = {
    ...
    support: {
        ...
        buttons: [
            ...
            { name: "DonatPay", url: "https://www.donationalerts.com/r/mieszko", color: "#673AB7", textColor: "#fff" }, // Кнопка не появится, пока нет ссылки
            { name: "Boosty", url: "https://www.donationalerts.com/r/mieszko", color: "#F15F2C", textColor: "#fff" },    // Кнопка не появится, пока нет ссылки
